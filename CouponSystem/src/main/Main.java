...
public class Main
{
	...
	{	
		...
		Customer customer = new Customer("Micheal");
		customer.setPassword("1986");
		
		// Prepare Coupon
		Coupon coupon = new Coupon();
		coupon.setEndDate(java.sql.Date.valueOf("2018-12-30"));
		coupon.setAmount(4);
		coupon.setMessage("this is a coupon");
		coupon.setPrice(45.0);
		coupon.setStartDate(java.sql.Date.valueOf("2018-03-13"));
		coupon.setTitle("g");
