...
public class JAXBContextResolver implements ContextResolver<JAXBContext> {
     ...
     * The class types.
     */
    private final Class[] types = {Company.class,Coupon.class,Customer.class};
    ...
    public JAXBContextResolver() throws Exception {
        this.context = new JSONJAXBContext(JSONConfiguration.mapped().arrays("coupon","company","customer").build(), types);
    }
